...
public class RobotContainer {
  ...
  public static JoyUtil secondaryController = new JoyUtil( Constants.Joysticks.secondaryControllerID );
    public static JoystickButton rebuffButton = new JoystickButton(secondaryController, Constants.Joysticks.Back);
    public static JoystickButton stepIntakeButton = new JoystickButton(secondaryController, Constants.Joysticks.RightBumper);
    public static JoystickButton autoShootRoutineButton = new JoystickButton(secondaryController, Constants.Joysticks.Y);
    public static JoystickButton dumpButton = new JoystickButton(secondaryController, Constants.Joysticks.A);
